...
export const CharageWallet = (props) => {
    ...
    let onSubmit = (completed = false) => {
        ...
        console.log(`${API_ENDPOINT}/payment/wallet/${props.res.data.paymentTransaction.id}`)
        setLoading(true);
        axios
            .get(
                `${API_ENDPOINT}/payment/wallet/${props.res.data.paymentTransaction.id}`,
                {
                    headers: {
...
export default connect(mapStateToProps)(CharageWallet);

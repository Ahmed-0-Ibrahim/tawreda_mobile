...
export const MostWanted = (props) => {
    ...
    // useEffect(() => {
    //     GetData();
    // }, [sortId, ShowLast, brandID, minPrice, maxPrice]);
    ...
    const GetData = async () => {
        setProducts([]);
        getTopSellingProducts(sortId, ShowLast, brandID, minPrice, maxPrice).then(res => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.bgS }}>
            <Header style={{ backgroundColor: colors.grayBackgroung }} title={t('MostWanted')} back />
